...
import { Button, Input, GradientText, Orb, Spinner } from '../components/UIComponents';
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <Orb color="primary" size={700} className="top-0 left-0 -translate-x-1/2 -translate-y-1/2" />
        <Orb color="accent" size={600} className="bottom-0 right-0 translate-x-1/2 translate-y-1/2" />
      </div>
