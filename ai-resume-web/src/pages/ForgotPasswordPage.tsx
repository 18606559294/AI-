        ...
        <div className="w-full">
          ...
          <div className="card-glass">
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              <div className={`w-8 h-1 rounded-full transition-colors ${step.type === 'email' || step.type === 'verify' || step.type === 'reset' ? 'bg-sky-500' : 'bg-slate-700'}`} />
              <div className={`w-8 h-1 rounded-full transition-colors ${step.type === 'verify' || step.type === 'reset' ? 'bg-sky-500' : 'bg-slate-700'}`} />
              <div className={`w-8 h-1 rounded-full transition-colors ${step.type === 'reset' ? 'bg-sky-500' : 'bg-slate-700'}`} />
            </div>
            ...
            {step.type === 'verify' && (
              <form onSubmit={handleVerifyCode} className="space-y-4">
                ...
                <button
                  ...
                  className="text-xs text-sky-400 hover:text-sky-300 disabled:text-slate-500 disabled:cursor-not-allowed transition-colors"
                >
