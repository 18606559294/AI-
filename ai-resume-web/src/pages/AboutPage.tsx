        ...
        <header className="border-b border-white/10 backdrop-blur-sm">
          <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link to="/resumes" className="text-slate-300 hover:text-amber-400 transition-colors">
                我的简历
              </Link>
              <Link to="/templates" className="text-slate-300 hover:text-amber-400 transition-colors">
                模板库
              </Link>
            </div>
          </div>
